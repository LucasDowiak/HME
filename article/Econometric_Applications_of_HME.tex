...
\begin{table}
  ...
  & \multicolumn{4}{c}{2 Component Mixture} & \multicolumn{6}{c}{3 Component Mixture} \\
  \cmidrule(r){2-5}  \cmidrule(r){7-12}
  & \multicolumn{2}{c}{OLS}  & \multicolumn{2}{c}{MoE} & & \multicolumn{2}{c}{OLS}  & \multicolumn{2}{c}{HME}  & \multicolumn{2}{c}{MoE} \\
...
\begin{table} \centering
  ...
  Depth & Experts & Min    & Mid    & Full    & Min   & Mid   & Full       \\
  \cmidrule{1-8}
  1     & 2       & -0.638 & -0.611 & -0.603  & 1.275 & 1.223 & 1.208      \\
  1     & 3       & -0.609 & -0.608 & -0.599  & 1.224 & 1.223 & 1.200      \\
  2     & 3       & -0.604 & -0.595 & -0.591  & 1.208 & 1.191 & 1.183      \\
  1     & 4       & -0.643 & -0.601 & --      & 1.294 & 1.212 & --         \\
  2     & 4       & -0.592 & -0.589 & -0.586  & 1.184 & 1.179 & 1.176      \\
  3     & 5       & -0.587 & -0.587 & -0.584  & 1.176 & 1.177 & 1.171      \\
...
\begin{table} \centering
  ...
  \hline
    \end{tabular}
    %\begin{tablenotes}
    %  \item[1]{\footnotesize Log-Likelihood is divided by the sample size (54,829)}
    %\end{tablenotes}
  \end{threeparttable}
\end{table}

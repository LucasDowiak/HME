...
\end{figure}
% There was a hope that the added variables would provided a much needed boost of
% density to the set of identifying features. Many of the Census 
% variables are discrete -- all of them except the wage, actually,
% if one thinks age and years of education lean more towards
% categorical variables than continuous ones. So in addition to their intrinsic value
% as points of economic and social interest, the job characteristics 

% From a practical
% optimization perspective, we will be using a gradient based approach to optimization, 
...
1    &    3    & -0.541  & 1.084  & 1.094  & 0.182 \\
1    &    4    & -0.537  & 1.078  & 1.091  & 0.181 \\
1    &    5    & -0.535  & 1.073  & 1.089  & 0.182 \\
2    &    3    & -0.524  & 1.052  & 1.061  & 0.182 \\
...
\begin{table} \centering
  ...
  1     & 3       & 0.051 & 0.081 & 0.076     \\
  1     & 4       & 0.039 & 0.085 & 0.075     \\
  1     & 5       & 0.063 & 0.095 & 0.076     \\
  2     & 3       & 0.063 & 0.080 & 0.074     \\
...
\cmidrule{1-7}    
                 & Coef.  &  SE   &  Coef.  &  SE   &  Coef.  &  SE   \\
\cmidrule(l){2-3}  \cmidrule(l){4-5}  \cmidrule(l){6-7}    
(Intercept)      &  1.310   & 0.016    &  2.039    & 0.033    &  1.234     & 0.017   \\
age16            &  0.046   & 0.002    &  0.150    & 0.004    &  0.031     & 0.001   \\
age16sq          & -0.001   & 0.000    & -0.011    & 0.000    & -0.000     & 0.000   \\
yreduc           &  0.055   & 0.001    & -0.028    & 0.003    &  0.081     & 0.001   \\
sex              & -0.046   & 0.004    &  0.021    & 0.009    & -0.234     & 0.004   \\
black            & -0.019   & 0.006    & -0.062    & 0.014    & -0.081     & 0.006   \\
indian           & -0.075   & 0.016    &  0.117    & 0.031    & -0.088     & 0.018   \\
asian            &  0.063   & 0.010    &  0.002    & 0.027    & -0.038     & 0.010   \\
hisp             & -0.044   & 0.005    & -0.047    & 0.010    & -0.118     & 0.006   \\
Creativity       & -0.003   & 0.003    & -0.039    & 0.007    & -0.049     & 0.003   \\
Design           &  0.054   & 0.003    &  0.118    & 0.005    &  0.081     & 0.002   \\
Analytics        &  0.131   & 0.003    &  0.005    & 0.007    &  0.128     & 0.003   \\
Perceptive       & -0.014   & 0.002    & -0.010    & 0.005    &  0.061     & 0.002   \\
variance         & -2.904   & 0.009    & -2.708    & 0.022    & -1.659     & 0.007   \\
\cmidrule(l){2-3}  \cmidrule(l){4-5}  \cmidrule(l){6-7}          
share:           &          & 0.088    &            & 0.030     &             & 0.881    \\ 
\cmidrule{1-7}     
      \end{tabular}
      }
      \begin{tablenotes}

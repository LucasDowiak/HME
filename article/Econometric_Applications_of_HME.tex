...
so that when at node $a$, split $i$ is the one needed in order to
reach exert $m$.
...
\begin{equation} \label{eq:gateScore}
  \begin{split}
    \boldsymbol{S}_{t}(\boldsymbol{\omega}^{a, i}) &\equiv \frac{\partial Q}{\partial \boldsymbol{\omega}^{a,i}} \\
                                                   &= \gateprod{h^{0}_{t}}{h^{a}_{t}} \left[h^{a, i}_{t} - g^{a, i}_{t} \right] Z_{t}
  \end{split}
\end{equation}
...
\begin{equation}
  \boldsymbol{S}_{t}(\boldsymbol{\omega}) = \left[\boldsymbol{S}_{t}(\boldsymbol{\omega}^{0}),
                                                  \boldsymbol{S}_{t}(\boldsymbol{\omega}^{1|a}),
                                                  \boldsymbol{S}_{t}(\boldsymbol{\omega}^{2|0})
                                                  \hdots \right]
\end{equation}

\begin{equation}
  \boldsymbol{S}(\boldsymbol{\omega}) = \sum_{t}^{T} \boldsymbol{S}_{t}(\boldsymbol{\omega})
\end{equation}
...
\begin{equation} \label{eq:nodehessian}
  \begin{split}
  \Ht{\bw{a}} &\equiv \frac{\partial^{2} Q}{\partial \boldsymbol{\omega}^{a,i} \partial \boldsymbol{\omega}^{a,j}} \\
     &= \gateprod{h^{0}}{h^{a}} Z_{t} \begin{bmatrix}
     g_{t}^{a|1}(1-g_{t}^{a|1}) & -g_{t}^{1|a}g_{t}^{2|a}    & \dots  & g_{t}^{1|a}g_{t}^{s-1|a}       \\
     -g_{t}^{1|a}g_{t}^{2|a}    & g_{t}^{a|2}(1-g_{t}^{a|2}) & \dots  & g_{t}^{2|a}g_{t}^{s-1|a}       \\
     \vdots                     &                            & \ddots & \vdots                 \\
     g_{t}^{1|a}g_{t}^{s-1|a}   &  \dots                     &        & g_{t}^{a|J-1}(1-g_{t}^{a|J-}) \\
  \end{bmatrix} Z_{t}^\top
  \end{split}
\end{equation}
...
\begin{equation} 
  \mathbf{H}_{t} =  \begin{bmatrix}
    \Ht{\bw{0}}    & \boldsymbol{0} & \boldsymbol{0} & \dots   \\
    \boldsymbol{0} & \Ht{\bw{1|0}}  & \boldsymbol{0} & \dots   \\
    \boldsymbol{0} & \boldsymbol{0} & \Ht{\bw{2|0}}  & \vdots  \\
    \vdots         & \vdots         & \vdots         & \ddots  \\
  \end{bmatrix}
\end{equation}

\begin{equation}
  \HH{\boldsymbol{\omega}} = \sum_{t}^{T} \Ht{\boldsymbol{\omega}}
\end{equation}

Leading to the sandwich estimator:

\begin{equation}
  \boldsymbol{V}(\boldsymbol{\omega}) = \HI{\boldsymbol{\omega}} \boldsymbol{S}(\boldsymbol{\omega}) \boldsymbol{S}(\boldsymbol{\omega})^\top \HI{\boldsymbol{\omega}}
\end{equation}
\section{HMRE}
